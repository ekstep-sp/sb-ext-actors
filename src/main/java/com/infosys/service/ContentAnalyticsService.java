...
public interface ContentAnalyticsService {
	...
	List<Map<String, Object>> getExternalResourcesList(String rootOrg, String org, String langCode, String startDate, String endDate, int searchSize, int offSet, String[] includeFields) throws IOException;
}
